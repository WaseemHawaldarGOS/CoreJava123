...
public class TimeComplexity {
    ...
    public void calculateTimeComplexityOofn() {
        ...
        System.out.println("Total time taken for 2 vars = "+(System.currentTimeMillis() - start)+"nano seconds");

        start = System.nanoTime();
        int ax = 3,ay = 3,z = 3,a = 3,b = 3,c = 3;
        System.out.println(ax+ay+z+a+b+c);
        System.out.println("Total time taken for 6 vars = "+(System.currentTimeMillis() - start)+"nano seconds");


        start = System.nanoTime();
        int xa = 3,aa = 3,ba = 3,ca = 3,d = 3,e = 3,f = 3,g = 3,h = 3,i = 3,j = 3,k = 3,l = 3,m = 3,n = 3;
        System.out.println(xa+aa+ba+ca+d+e+f+g+h+i+j+k+l+m+n);
        System.out.println("Total time taken for 15 vars = "+(System.currentTimeMillis() - start)+"nano seconds");

    }

    /*
    Below method demonstrates that time complexity for below program is O(logn).
    O(logn) is most commonly achieved using binary search algorithm.
    i.e. dividing elements by half for every search done unless we find the required element.
    */
    ...
    Yet to be understood nlogn behavior.
     */
